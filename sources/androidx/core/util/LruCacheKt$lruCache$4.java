...
public final class LruCacheKt$lruCache$4 extends LruCache<K, V> {
    ...
    public LruCacheKt$lruCache$4(Function2<? super K, ? super V, Integer> $sizeOf2, Function1<? super K, ? extends V> $create2, Function4<? super Boolean, ? super K, ? super V, ? super V, Unit> $onEntryRemoved2, int $maxSize2) {
        super($maxSize2);
        this.$sizeOf = $sizeOf2;
        this.$create = $create2;
