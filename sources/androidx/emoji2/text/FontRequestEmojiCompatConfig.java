    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void createMetadata() {
            /*
                ...
                monitor-enter(r0)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r1 = r8.mCallback     // Catch:{ all -> 0x00a9 }
                if (r1 != 0) goto L_0x0009
                monitor-exit(r0)     // Catch:{ all -> 0x00a9 }
                return
            L_0x0009:
                monitor-exit(r0)     // Catch:{ all -> 0x00a9 }
                androidx.core.provider.FontsContractCompat$FontInfo r0 = r8.retrieveFontInfo()     // Catch:{ all -> 0x0095 }
                int r1 = r0.getResultCode()     // Catch:{ all -> 0x0095 }
                r2 = 2
                if (r1 != r2) goto L_0x0034
                java.lang.Object r2 = r8.mLock     // Catch:{ all -> 0x0095 }
                monitor-enter(r2)     // Catch:{ all -> 0x0095 }
            ...
            L_0x0034:
                ...
                androidx.core.os.TraceCompat.beginSection(r2)     // Catch:{ all -> 0x0074 }
                ...
                android.content.Context r3 = r8.mContext     // Catch:{ all -> 0x0074 }
                r4 = 0
                android.net.Uri r5 = r0.getUri()     // Catch:{ all -> 0x0074 }
                java.nio.ByteBuffer r3 = androidx.core.graphics.TypefaceCompatUtil.mmap(r3, r4, r5)     // Catch:{ all -> 0x0074 }
                ...
                androidx.core.os.TraceCompat.endSection()     // Catch:{ all -> 0x0095 }
                java.lang.Object r2 = r8.mLock     // Catch:{ all -> 0x0095 }
                monitor-enter(r2)     // Catch:{ all -> 0x0095 }
            ...
            L_0x0079:
                java.lang.RuntimeException r2 = new java.lang.RuntimeException     // Catch:{ all -> 0x0095 }
                ...
                r3.append(r4)     // Catch:{ all -> 0x0095 }
                r3.append(r1)     // Catch:{ all -> 0x0095 }
                java.lang.String r4 = ")"
                r3.append(r4)     // Catch:{ all -> 0x0095 }
            ...
            L_0x0095:
                ...
                monitor-enter(r2)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r0 = r8.mCallback     // Catch:{ all -> 0x00a6 }
                if (r0 == 0) goto L_0x00a1
                r0.onFailed(r1)     // Catch:{ all -> 0x00a6 }
            L_0x00a1:
