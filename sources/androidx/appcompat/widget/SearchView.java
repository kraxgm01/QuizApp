...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int layoutResId = a2.getResourceId(R.styleable.SearchView_layout, R.layout.abc_search_view);
        ...
        ViewCompat.setBackground(findViewById, a2.getDrawable(R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, a2.getDrawable(R.styleable.SearchView_submitBackground));
