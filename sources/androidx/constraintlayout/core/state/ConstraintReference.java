        ...
        if (this.mConstraintWidget != null) {
            ...
            if (hashMap != null) {
                for (String key2 : hashMap.keySet()) {
                    this.mConstraintWidget.frame.setCustomAttribute(key2, (int) TypedValues.Custom.TYPE_COLOR, this.mCustomColors.get(key2).intValue());
                }
            }
            HashMap<String, Float> hashMap2 = this.mCustomFloats;
            if (hashMap2 != null) {
                for (String key3 : hashMap2.keySet()) {
                    this.mConstraintWidget.frame.setCustomAttribute(key3, (int) TypedValues.Custom.TYPE_FLOAT, this.mCustomFloats.get(key3).floatValue());
                }
            }
        }
    }
