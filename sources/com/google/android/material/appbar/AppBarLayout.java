...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            setScrollEffect(createScrollEffectFromInt(a.getInt(R.styleable.AppBarLayout_Layout_layout_scrollEffect, 0)));
                    ...
                    if (offsetChanged) {
                        for (int i = 0; i < appBarLayout.getChildCount(); i++) {
                            ...
                            if (!(scrollEffect == null || (params.getScrollFlags() & 1) == 0)) {
                                scrollEffect.onOffsetChanged(appBarLayout, appBarLayout.getChildAt(i), (float) getTopAndBottomOffset());
                            }
                        }
                    }
