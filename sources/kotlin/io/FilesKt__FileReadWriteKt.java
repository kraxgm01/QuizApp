...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(java.io.File r15) {
        /*
            ...
            r1 = r0
            java.io.FileInputStream r1 = (java.io.FileInputStream) r1     // Catch:{ all -> 0x00ba }
            r2 = 0
            r3 = 0
            long r4 = r15.length()     // Catch:{ all -> 0x00ba }
            r6 = r4
            r8 = 0
            ...
            int r5 = (int) r4
            r4 = r5
            byte[] r5 = new byte[r4]     // Catch:{ all -> 0x00ba }
        L_0x0026:
            if (r4 <= 0) goto L_0x0032
            int r6 = r1.read(r5, r3, r4)     // Catch:{ all -> 0x00ba }
        ...
        L_0x0032:
            ...
            byte[] r8 = java.util.Arrays.copyOf(r5, r3)     // Catch:{ all -> 0x00ba }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r8, r6)     // Catch:{ all -> 0x00ba }
            r5 = r8
            goto L_0x007a
        L_0x0040:
            int r8 = r1.read()     // Catch:{ all -> 0x00ba }
            r9 = -1
            if (r8 != r9) goto L_0x0048
            goto L_0x007a
        L_0x0048:
            kotlin.io.ExposingBufferByteArrayOutputStream r9 = new kotlin.io.ExposingBufferByteArrayOutputStream     // Catch:{ all -> 0x00ba }
            r10 = 8193(0x2001, float:1.1481E-41)
            r9.<init>(r10)     // Catch:{ all -> 0x00ba }
            r9.write(r8)     // Catch:{ all -> 0x00ba }
            r10 = r1
            java.io.InputStream r10 = (java.io.InputStream) r10     // Catch:{ all -> 0x00ba }
            r12 = r9
            java.io.OutputStream r12 = (java.io.OutputStream) r12     // Catch:{ all -> 0x00ba }
            r13 = 2
            r14 = 0
            kotlin.io.ByteStreamsKt.copyTo$default(r10, r12, r14, r13, r7)     // Catch:{ all -> 0x00ba }
            int r10 = r5.length     // Catch:{ all -> 0x00ba }
            int r12 = r9.size()     // Catch:{ all -> 0x00ba }
            int r10 = r10 + r12
            if (r10 < 0) goto L_0x007e
            byte[] r11 = r9.getBuffer()     // Catch:{ all -> 0x00ba }
            byte[] r12 = java.util.Arrays.copyOf(r5, r10)     // Catch:{ all -> 0x00ba }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r12, r6)     // Catch:{ all -> 0x00ba }
            int r6 = r5.length     // Catch:{ all -> 0x00ba }
            int r13 = r9.size()     // Catch:{ all -> 0x00ba }
            byte[] r6 = kotlin.collections.ArraysKt.copyInto((byte[]) r11, (byte[]) r12, (int) r6, (int) r14, (int) r13)     // Catch:{ all -> 0x00ba }
            r5 = r6
        L_0x007a:
            kotlin.io.CloseableKt.closeFinally(r0, r7)
            return r5
        L_0x007e:
            java.lang.OutOfMemoryError r6 = new java.lang.OutOfMemoryError     // Catch:{ all -> 0x00ba }
            ...
            r7.append(r15)     // Catch:{ all -> 0x00ba }
            ...
            throw r6     // Catch:{ all -> 0x00ba }
        L_0x0098:
            java.lang.OutOfMemoryError r4 = new java.lang.OutOfMemoryError     // Catch:{ all -> 0x00ba }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ba }
            r5.<init>()     // Catch:{ all -> 0x00ba }
            r5.append(r11)     // Catch:{ all -> 0x00ba }
            r5.append(r15)     // Catch:{ all -> 0x00ba }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static /* synthetic */ java.lang.Object useLines$default(java.io.File r7, java.nio.charset.Charset r8, kotlin.jvm.functions.Function1 r9, int r10, java.lang.Object r11) {
        /*
            r11 = 1
            r10 = r10 & r11
        ...
        L_0x0026:
            ...
            r5 = 0
            kotlin.sequences.Sequence r6 = kotlin.io.TextStreamsKt.lineSequence(r3)     // Catch:{ all -> 0x003f }
            java.lang.Object r6 = r9.invoke(r6)     // Catch:{ all -> 0x003f }
    ...
    public static final <T> T useLines(java.io.File r7, java.nio.charset.Charset r8, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r9) {
        ...
        L_0x002d:
            ...
            r3 = 1
            r4 = r2
            java.io.BufferedReader r4 = (java.io.BufferedReader) r4     // Catch:{ all -> 0x0047 }
            r5 = 0
            kotlin.sequences.Sequence r6 = kotlin.io.TextStreamsKt.lineSequence(r4)     // Catch:{ all -> 0x0047 }
            java.lang.Object r6 = r9.invoke(r6)     // Catch:{ all -> 0x0047 }
