...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    private static final String toRelativeStringOrNull$FilesKt__UtilsKt(File $this$toRelativeStringOrNull, File base) {
        ...
        while (i2 < maxSameCount && Intrinsics.areEqual((Object) thisComponents.getSegments().get(i2), (Object) baseComponents.getSegments().get(i2))) {
            i2++;
        }
        int sameCount = i2;
        ...
        if (sameCount <= i3) {
            do {
                i = i3;
                i3--;
                if (Intrinsics.areEqual((Object) baseComponents.getSegments().get(i).getName(), (Object) "..")) {
                    return null;
                }
                res.append("..");
                if (i != sameCount) {
    ...
    public static final File resolve(File $this$resolve, File relative) {
        ...
        if ((baseName.length() == 0) || StringsKt.endsWith$default((CharSequence) baseName, File.separatorChar, false, 2, (Object) null)) {
            return new File(Intrinsics.stringPlus(baseName, relative));
        }
