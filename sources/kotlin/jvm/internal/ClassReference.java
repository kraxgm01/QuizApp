...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
        ...
        public final String getClassSimpleName(Class<?> jClass) {
            ...
            if (jClass.isLocalClass()) {
                ...
                if (method == null) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(name, "name");
                    return StringsKt.substringAfter$default(name, Intrinsics.stringPlus(constructor.getName(), "$"), (String) null, 2, (Object) null);
                }
                Intrinsics.checkNotNullExpressionValue(name, "name");
                return StringsKt.substringAfter$default(name, Intrinsics.stringPlus(method.getName(), "$"), (String) null, 2, (Object) null);
    ...
    static {
        ...
        for (Map.Entry next : FUNCTION_CLASSES.entrySet()) {
            $this$classFqNames_u24lambda_u2d4.put(((Class) next.getKey()).getName(), Intrinsics.stringPlus("kotlin.Function", Integer.valueOf(((Number) next.getValue()).intValue())));
        }
