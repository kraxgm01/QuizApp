...
public final class TypeReference implements KType {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        if (javaClass == null) {
            ...
            klass = JvmClassMappingKt.getJavaObjectType((KClass) getClassifier()).getName();
        }
        String nullable = "";
        ...
        if (upper instanceof TypeReference) {
            ...
            if (!Intrinsics.areEqual((Object) renderedUpper, (Object) result)) {
                if (Intrinsics.areEqual((Object) renderedUpper, (Object) Intrinsics.stringPlus(result, "?"))) {
                    return Intrinsics.stringPlus(result, "!");
                }
