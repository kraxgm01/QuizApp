...
public interface ContinuationInterceptor extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(ContinuationInterceptor continuationInterceptor, R initial, Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
            Intrinsics.checkNotNullParameter(continuationInterceptor, "this");
            Intrinsics.checkNotNullParameter(operation, "operation");
            return CoroutineContext.Element.DefaultImpls.fold(continuationInterceptor, initial, operation);
        }
        ...
        public static <E extends CoroutineContext.Element> E get(ContinuationInterceptor continuationInterceptor, CoroutineContext.Key<E> key) {
            ...
            if (key instanceof AbstractCoroutineContextKey) {
                ...
                E tryCast$kotlin_stdlib = ((AbstractCoroutineContextKey) key).tryCast$kotlin_stdlib(continuationInterceptor);
