...
public final class UnsignedKt {
    ...
    public static final long m385ulongDivideeb3DHEI(long v1, long v2) {
        ...
        if (divisor < 0) {
            ...
            return ULong.m208constructorimpl(j);
        } else if (dividend >= 0) {
            return ULong.m208constructorimpl(dividend / divisor);
        } else {
            int i = 1;
            long quotient = ((dividend >>> 1) / divisor) << 1;
            if (ulongCompare(ULong.m208constructorimpl(dividend - (quotient * divisor)), ULong.m208constructorimpl(divisor)) < 0) {
                i = 0;
            }
            return ULong.m208constructorimpl(((long) i) + quotient);
        }
    }
    ...
    public static final long m386ulongRemaindereb3DHEI(long v1, long v2) {
        ...
        if (divisor < 0) {
            ...
            return ULong.m208constructorimpl(v1 - v2);
        } else if (dividend >= 0) {
            return ULong.m208constructorimpl(dividend % divisor);
        } else {
            long rem = dividend - ((((dividend >>> 1) / divisor) << 1) * divisor);
            if (ulongCompare(ULong.m208constructorimpl(rem), ULong.m208constructorimpl(divisor)) >= 0) {
                j = divisor;
            }
            return ULong.m208constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= 2.147483647E9d) {
            return UInt.m130constructorimpl((int) v);
        }
        return UInt.m130constructorimpl(UInt.m130constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m130constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        if (v < 9.223372036854776E18d) {
            return ULong.m208constructorimpl((long) v);
        }
        return ULong.m208constructorimpl(ULong.m208constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
