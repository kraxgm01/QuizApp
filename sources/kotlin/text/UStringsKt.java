...
public final class UStringsKt {
    ...
    public static final String m1308toStringLxnNnR4(byte $this$toString, int radix) {
    ...
    public static final String m1310toStringolVBNx4(short $this$toString, int radix) {
    ...
    public static final String m1309toStringV7xB4Y4(int $this$toString, int radix) {
    ...
    public static final String m1307toStringJSWoG40(long $this$toString, int radix) {
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int r0 = uIntOrNull.m181unboximpl();
        if (UnsignedKt.uintCompare(r0, UInt.m130constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m130constructorimpl(radix);
        int result = 0;
        int i = start;
        while (i < length) {
            int i2 = i;
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m383uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m130constructorimpl(result * uradix);
            int beforeAdding = result2;
            result = UInt.m130constructorimpl(UInt.m130constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, beforeAdding) < 0) {
                return null;
            }
        }
        return UInt.m124boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m208constructorimpl((long) i);
        long result = 0;
        int digit = start;
        while (digit < i2) {
            int length = i2;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m385ulongDivideeb3DHEI(-1, uradix);
                if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            long result2 = ULong.m208constructorimpl(result * uradix);
            long beforeAdding = result2;
            result = ULong.m208constructorimpl(ULong.m208constructorimpl(((long) UInt.m130constructorimpl(digit2)) & 4294967295L) + result2);
        ...
        return ULong.m202boximpl(result);
    }
}
