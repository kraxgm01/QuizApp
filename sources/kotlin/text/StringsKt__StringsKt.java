...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final String trimStart(String $this$trimStart, char... chars) {
        ...
        while (true) {
            ...
            int index$iv$iv = i;
            i++;
            if (ArraysKt.contains(chars, $this$trimStart$iv$iv.charAt(index$iv$iv)) == 0) {
    ...
    private static final String replaceFirstCharWithCharSequence(String $this$replaceFirstChar, Function1<? super Character, ? extends CharSequence> transform) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(transform.invoke(Character.valueOf($this$replaceFirstChar.charAt(0))));
        String substring = $this$replaceFirstChar.substring(1);
        Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String).substring(startIndex)");
        sb.append(substring);
        return sb.toString();
    ...
    public static final int indexOfAny(CharSequence $this$indexOfAny, char[] chars, int startIndex, boolean ignoreCase) {
        int index;
        boolean z;
        CharSequence charSequence = $this$indexOfAny;
        char[] cArr = chars;
        int i = startIndex;
        ...
        if (z2 || cArr.length != 1 || !(charSequence instanceof String)) {
            ...
            do {
                ...
                while (true) {
                    ...
                    char element$iv = $this$any$iv[i2];
                    i2++;
                    if (CharsKt.equals(element$iv, charAtIndex, z2) != 0) {
                        z = true;
                        break;
                    }
                }
    ...
    public static final int lastIndexOfAny(CharSequence $this$lastIndexOfAny, char[] chars, int startIndex, boolean ignoreCase) {
        CharSequence charSequence = $this$lastIndexOfAny;
        char[] cArr = chars;
        int i = startIndex;
        ...
        if (z || cArr.length != 1 || !(charSequence instanceof String)) {
            int coerceAtMost = RangesKt.coerceAtMost(i, StringsKt.getLastIndex($this$lastIndexOfAny));
            if (coerceAtMost >= 0) {
                do {
                    ...
                    while (true) {
                        ...
                        char element$iv = $this$any$iv[i2];
                        i2++;
                        if (CharsKt.equals(element$iv, charAtIndex, z) != 0) {
                            z2 = true;
                            break;
                        }
                    }
    ...
    private static final int indexOf$StringsKt__StringsKt(CharSequence $this$indexOf, CharSequence other, int startIndex, int endIndex, boolean ignoreCase, boolean last) {
        ...
        CharSequence charSequence2 = other;
        int i = startIndex;
        int i2 = endIndex;
        if (!last) {
        ...
        if (!(charSequence instanceof String) || !(charSequence2 instanceof String)) {
            ...
            while (true) {
                int index2 = first;
                int i3 = first + step;
                if (StringsKt.regionMatchesImpl(other, 0, $this$indexOf, index2, other.length(), ignoreCase)) {
                    return index2;
                }
                if (index2 == last2) {
                    return -1;
            ...
            do {
                index = first2;
                first2 += step2;
                if (StringsKt.regionMatches((String) charSequence2, 0, (String) charSequence, index, other.length(), ignoreCase)) {
                    return index;
                }
            } while (index != last3);
            return -1;
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence $this$findAnyOf, Collection<String> strings, int startIndex, boolean ignoreCase, boolean last) {
        ...
        String str = string;
        int i4 = startIndex;
        int index3 = !last ? StringsKt.indexOf$default(charSequence2, str, i4, false, 4, (Object) null) : StringsKt.lastIndexOf$default(charSequence2, str, i4, false, 4, (Object) null);
        if (index3 < 0) {
            return null;
        }
