...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(String $this$replace, char oldChar, char newChar, boolean ignoreCase) {
        ...
        StringBuilder $this$replace_u24lambda_u2d1 = sb;
        CharSequence $this$forEach$iv = $this$replace;
        int i = 0;
        while (i < $this$forEach$iv.length()) {
    ...
    public static final String replace(String $this$replace, String oldValue, String newValue, boolean ignoreCase) {
        ...
        if (newLengthHint >= 0) {
            ...
            int i = 0;
            do {
                stringBuilder.append($this$replace_u24lambda_u2d2, i, occurrenceIndex);
                stringBuilder.append(newValue);
                i = occurrenceIndex + oldValueLength;
                if (occurrenceIndex >= $this$replace_u24lambda_u2d2.length() || (occurrenceIndex = StringsKt.indexOf((CharSequence) $this$replace_u24lambda_u2d2, oldValue, occurrenceIndex + searchStep, ignoreCase)) <= 0) {
                    stringBuilder.append($this$replace_u24lambda_u2d2, i, $this$replace_u24lambda_u2d2.length());
                ...
                i = occurrenceIndex + oldValueLength;
                break;
            } while ((occurrenceIndex = StringsKt.indexOf((CharSequence) $this$replace_u24lambda_u2d2, oldValue, occurrenceIndex + searchStep, ignoreCase)) <= 0);
            stringBuilder.append($this$replace_u24lambda_u2d2, i, $this$replace_u24lambda_u2d2.length());
    ...
    public static final String capitalize(String $this$capitalize, Locale locale) {
        ...
        if ($this$capitalize.length() > 0) {
            ...
            if (Character.isLowerCase(firstChar)) {
                ...
                StringBuilder $this$capitalize_u24lambda_u2d5 = sb;
