...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1316getAdjustmentUwyO8pc() {
    ...
    public long m1315elapsedNowUwyO8pc() {
        return Duration.m1357minusLRDsOJo(this.mark.m1451elapsedNowUwyO8pc(), m1316getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1317plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1358plusLRDsOJo(m1316getAdjustmentUwyO8pc(), duration), (DefaultConstructorMarker) null);
    }
}
