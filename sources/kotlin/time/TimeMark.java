...
public abstract class TimeMark {
    ...
    public abstract long m1451elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1453plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this, duration, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1452minusLRDsOJo(long duration) {
        return m1453plusLRDsOJo(Duration.m1374unaryMinusUwyO8pc(duration));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1355isNegativeimpl(m1451elapsedNowUwyO8pc());
    }
