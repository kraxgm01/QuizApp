...
public final class SubSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    public SubSequence(Sequence<? extends T> sequence2, int startIndex2, int endIndex2) {
        ...
        if (startIndex2 >= 0) {
            ...
            throw new IllegalArgumentException(Intrinsics.stringPlus("endIndex should be non-negative, but is ", Integer.valueOf(endIndex2)).toString());
        }
        throw new IllegalArgumentException(Intrinsics.stringPlus("startIndex should be non-negative, but is ", Integer.valueOf(startIndex2)).toString());
    }
