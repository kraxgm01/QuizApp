...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m35boximpl(Object obj) {
    ...
    public static boolean m37equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m45unboximpl());
    }
    ...
    public static int m41hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public final /* synthetic */ Object m45unboximpl() {
        return this.value;
    }
    ...
    public static final boolean m43isSuccessimpl(Object arg0) {
        return !(arg0 instanceof Failure);
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m42isFailureimpl(Object arg0) {
        return arg0 instanceof Failure;
    }

    /* renamed from: getOrNull-impl  reason: not valid java name */
    private static final T m40getOrNullimpl(Object arg0) {
        if (m42isFailureimpl(arg0)) {
            return null;
        }
        return arg0;
    }
    ...
    public static final Throwable m39exceptionOrNullimpl(Object arg0) {
    ...
    public static String m44toStringimpl(Object arg0) {
        if (arg0 instanceof Failure) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T value) {
            return Result.m36constructorimpl(value);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m36constructorimpl(ResultKt.createFailure(exception));
        }
    }
